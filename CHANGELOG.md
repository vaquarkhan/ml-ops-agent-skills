...
- zkML integration tests skip gracefully when ezkl CLI is absent (`@requires_ezkl` + `pytest.importorskip` for torch/onnx)
- Reference checklists now include **Sources** tables with URLs and last-reviewed dates
